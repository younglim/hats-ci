...
$fso.DeleteFile("$path_to_hats\chromedriver-32-chrome81.zip")
$fso.DeleteFile("$path_to_hats\chromedriver-32-chrome80.zip")
$fso.DeleteFile("$path_to_hats\chromedriver-32-chrome79.zip")
