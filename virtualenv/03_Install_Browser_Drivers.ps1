...
Start-Process -FilePath "$path_to_hats\7-Zip\Files\7-Zip\7z.exe" -ArgumentList 'e', '"geckodriver-32-firefox54.zip"', '-o"drivers\win32\firefox-54"', '-aoa' -NoNewWindow -Wait -WorkingDirectory "$path_to_hats"
