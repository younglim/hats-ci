...
Start-Process -FilePath "$path_to_hats\7-Zip\Files\7-Zip\7z.exe" -ArgumentList 'e', '"IEDriverServer-32.zip"', '-o"drivers\ie"', '-aoa' -NoNewWindow -Wait -WorkingDirectory "$path_to_hats"
